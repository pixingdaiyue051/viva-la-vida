...
public class MapHandler {
    ...
    public  void linkedHashMapOnDemo() {
    ...
    private  void decodeDec2Bin(StringBuilder builder, int key) {
        int tmp = key >>> 1;
        if (tmp > 0) {

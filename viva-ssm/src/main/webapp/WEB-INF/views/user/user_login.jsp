...
<html>
  ...
  <body>
  	<a href="${webroot}/base/i18nNew.do?language=zw">中文</a>
  	<a href="${webroot}/base/i18nNew.do?language=ft">繁體</a>
  	<a href="${webroot}/base/i18nNew.do?language=yw">English</a>
  	<form action="${webroot}/um/user/login.do" method="POST">
  		<table>
    	<tr>
